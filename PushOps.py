...
def stream2BQ(p_siteData):
    try:
            ...
            if cookies is not None:
                for item in cookies:
                    ...
                    try:
                        ...
                        execBQRows('ifis-web-measurements.cookies.cookies', item, 25)
            ...
            if localStorage is not None:
                for item in localStorage:
                    ...
                    try:
                        ...
                        execBQRows(
                            'ifis-web-measurements.cookies.localstorage', item, 25)
                    except Exception as e:
                        pushError(siteData.site_id,
        ...
        try:
            execBQRows('ifis-web-measurements.cookies.requests', all_requests, 45)
            all_pushed_req = True
        except:
            all_pushed_req = False
            ...
            for visit in siteData.visitData:
                ...
                if requests is not None:
                    for item in requests:
                        ...
                        try:
                            execBQRows(
                                'ifis-web-measurements.cookies.requests', item, 15)
                        except:
        ...
        try:
            execBQRows('ifis-web-measurements.cookies.responses', all_response, 45)
            all_pushed_res = True
        except:
            all_pushed_res = False
            ...
            for visit in siteData.visitData:
                ...
                if responses is not None:
                    for item in responses:
                        ...
                        try:
                            execBQRows(
                                'ifis-web-measurements.cookies.responses', item, 15)
                        except:
        ...
        if all_callstacks:
            ...
            try:
                execBQRows('ifis-web-measurements.cookies.callstacks', all_callstacks, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if callstacks is not None:
                        for item in callstacks:
                            ...
                            try:
                                execBQRows(
                                    'ifis-web-measurements.cookies.callstacks', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_dns_responses:
            ...
            try:
                execBQRows('ifis-web-measurements.cookies.dns_responses', all_dns_responses, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if dns_responses is not None:
                        for item in dns_responses:
                            ...
                            try:
                                execBQRows(
                                    'ifis-web-measurements.cookies.dns_responses', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_incomplete_visit: 
            ...
            try:
                execBQRows('ifis-web-measurements.cookies.incomplete_visits', all_incomplete_visit, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if incomplete_visit is not None:
                        for item in incomplete_visit:
                            ...
                            try:
                                execBQRows(
                                    'ifis-web-measurements.cookies.incomplete_visits', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_http_redirects:
            ...
            try:
                execBQRows('ifis-web-measurements.cookies.http_redirects', all_http_redirects, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if http_redirects is not None:
                        for item in http_redirects:
                            ...
                            try:
                                execBQRows(
                                    'ifis-web-measurements.cookies.http_redirects', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_navigations:
            ...
            try:
                execBQRows('ifis-web-measurements.cookies.navigations', all_navigations, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if navigations is not None:
                        for item in navigations:
                            ...
                            try:
                                execBQRows(
                                    'ifis-web-measurements.cookies.navigations', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        for visit in siteData.visitData:  
            ...
            if requests is not None:  
                for item in requests:
                    ...
                    push_request = push_request + len(item)
                    try:
                        execBQRows('ifis-web-measurements.cookies.requests', item) 
                    except:
            ...
            if responses is not None:
                ...
                for item in responses:
                    ...
                    try:
                        execBQRows('ifis-web-measurements.cookies.responses', item) 
                    except:
                        print(item)
    ...
    if siteData.crawlData != None:
        ...
        for item in allReq:
            print('pushing chunked req: ', str(len(item)))
            try:
                execBQRows('ifis-web-measurements.cookies.http_request',
                           item)
                push_request=1
            except:
        ...
        for item in allRes:
            print('pushing chunked res: ', str(len(item)))
            try:
                execBQRows('ifis-web-measurements.cookies.http_response',
                       item)
                push_response=1
            except:
                print(item)
        ...
        if siteData.cookies:
            try:
                ...
                execBQRows('ifis-web-measurements.cookies.cookies', siteData.cookies)
                push_cookie=1
            except Exception as e:
        ...
        if siteData.localStorage:
            try:
                ...
                execBQRows('ifis-web-measurements.cookies.localstorage',
